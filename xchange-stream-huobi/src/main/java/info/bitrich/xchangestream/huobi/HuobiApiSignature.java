...
class HuobiApiSignature {
  ...
  void createSignature(
    ...
    if (accessKey == null || "".equals(accessKey) || secretKey == null || "".equals(secretKey)) {
      throw new RuntimeException("API key and secret key are required");
    }
    ...
    builder
        .putToUrl(ACCESS_KEY_NAME, accessKey)
    ...
    try {
      ...
      SecretKeySpec secKey =
          new SecretKeySpec(secretKey.getBytes(StandardCharsets.UTF_8), SIGNATURE_METHOD_VALUE);
